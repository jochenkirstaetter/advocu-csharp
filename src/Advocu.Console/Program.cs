        ...
        using (var scope = host.Services.CreateScope())
        {
            ...
            try
            {
                ...
                var interactionRequest = new CreateInteractionWithGooglersActivityRequest()
                {
                    ...
                    Format = AdvocuFormat.Online_feedback_sessions,
                    InteractionType = AdvocuInteractionType.Other_Interactions_with_Google_Product_Teams,
                    TimeSpent = 45,
                ...
                var storiesRequest = new CreateStoriesActivityRequest()
                {
                    ...
                    Description = "",
                    WhyIsSignificant = "",
                    SignificanceType = AdvocuSignificanceType.Technology_Open_source,
                    Tags = new List<string> {},
                    Impact = 100,
                    AdditionalInfo = "",
                    Private = false
