...
public sealed class CreateWorkshopActivityRequest : ActivityRequest, IValidatableObject
{
    ...
    public required string ActivityDate { get; set; } // "Date of your workshop", Pattern YYYY-MM-DD
    ...
    public required string ActivityUrl { get; set; } // "Share the event link (if it's a GDG event, the gdg.community.dev event URL) or any other relevant link"
